...
- (void)layoutSubviews
{
    ...
    CGFloat titleWidth = _contentView.fs_width - self.calendar.appearance.headerTitleInsets.left - self.calendar.appearance.headerTitleInsets.right;
    ...
    _titleLabel.frame = CGRectMake(self.calendar.appearance.headerTitleInsets.left,
                                   _bottomBorder.fs_bottom - titleHeight - weekdayMargin,
                                   titleWidth,
                                   titleHeight);
}
...
- (void)setMonth:(NSDate *)month
{
    ...
    BOOL usesUpperCase = (self.calendar.appearance.caseOptions & FSCalendarCaseOptionsHeaderUsesUpperCase) != 0;
    BOOL usesCapitalCase = (self.calendar.appearance.caseOptions & FSCalendarCaseOptionsHeaderUsesCapitalCase) != 0;
    
    NSString *text = [_calendar.formatter stringFromDate:_month];
    
    if (usesUpperCase) {
        text = text.uppercaseString;
    } else if (usesCapitalCase) {
